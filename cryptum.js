(function(root, factory){
	if (typeof exports === "object"){
		...
		root.Cryptum = factory();
	}
}(this, function(){
	var Cryptum = Cryptum || (function(Math, undefined){
		var C = {};
		var C_lib = C.lib = {};
  ...
  Cryptum.lib.Cipher || (function (undefined){
    var C = Cryptum;
    var C_lib = C.lib;
    var Base = C_lib.Base;
    var WordArray = C_lib.WordArray;
	...
	Cryptum.mode.CFB = (function(){
    var CFB = Cryptum.lib.BlockCipherMode.extend();
	...
	Cryptum.mode.ECB = (function(){
    var ECB = Cryptum.lib.BlockCipherMode.extend();
	...
	Cryptum.pad.Iso10126 = {
    pad: function (data, blockSize){
      var blockSizeBytes = blockSize * 4;
      var nPaddingBytes = blockSizeBytes - data.sigBytes % blockSizeBytes;
      data.concat(Cryptum.lib.WordArray
        .random(nPaddingBytes - 1))
        .concat(Cryptum.lib.WordArray
	...
	Cryptum.pad.Iso97971 = {
    pad: function (data, blockSize){
      data.concat(Cryptum.lib.WordArray.create([0x80000000], 1));
      Cryptum.pad.ZeroPadding.pad(data, blockSize);
    },
    unpad: function (data){
      Cryptum.pad.ZeroPadding.unpad(data);
      data.sigBytes--;
    }
	};
	Cryptum.mode.OFB = (function(){
    var OFB = Cryptum.lib.BlockCipherMode.extend();
  ...
  (function(){
	...
	Cryptum.mode.CTRGladman = (function(){
    var CTRGladman = Cryptum.lib.BlockCipherMode.extend();
  ...
  (function(){
	...
	Cryptum.mode.CTR = (function(){
    var CTR = Cryptum.lib.BlockCipherMode.extend();
